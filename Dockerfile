...
RUN apk add --update --no-cache $PACKAGES && \
        ...
        npm install -y && NODE_OPTIONS=--openssl-legacy-provider npm run build && \
...
# composer config -g github-oauth.github.com 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 && \
...
ENV OMP_VERSION="3_3_0-14"       \
        ...
        php81-apache2 php81-zlib php81-json php81-phar php81-openssl \
        php81-curl php81-pdo_mysql php81-ctype php81-zip \
        php81-gd php81-xml php81-dom php81-iconv php81-mysqli php81-mbstring \
        php81-session php81-xml php81-simplexml php81-xsl"   
